...
import value from '@ecommerce-frontend/src/assets/scss/_themes-vars.module.scss';
import { NumbColorFunc, StringBoolFunc, StringNumFunc } from '@ecommerce-frontend/src/common/types';
