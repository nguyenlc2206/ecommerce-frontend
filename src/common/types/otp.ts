...
type TextFieldProps = Omit<
    MuiTextFieldProps,
    'onChange' | 'select' | 'multiline' | 'defaultValue' | 'value' | 'autoFocus' | 'placeholder'
>;
...
export interface BaseMuiOtpInputProps {
    ...
    TextFieldsProps?: TextFieldProps & {
        placeholder?: MuiTextFieldProps['placeholder'] | ((index: number) => MuiTextFieldProps['placeholder']);
    };
