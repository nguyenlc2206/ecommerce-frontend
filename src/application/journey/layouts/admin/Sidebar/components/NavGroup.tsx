...
import { activeID } from '@ecommerce-frontend/src/infras/data/store/reducers/menu';
...
import NavCollapse from '@ecommerce-frontend/src/application/journey/layouts/admin/Sidebar/components/NavCollapse';
