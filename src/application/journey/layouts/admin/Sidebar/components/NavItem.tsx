...
import { activeID, activeItem, openDrawer } from '@ecommerce-frontend/src/infras/data/store/reducers/menu';
import { LinkTarget, NavItemType } from '@ecommerce-frontend/src/common/types';
